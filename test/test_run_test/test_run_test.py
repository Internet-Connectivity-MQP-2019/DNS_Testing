...
def build_result(rtt):
    return dig.DigResults(answer=0, authority=12, additional=0, status="NOERROR",
                          ...
                          additional_section=[], query_time=rtt, msg_size=0,
...
class MyTestCase(unittest.TestCase):
    ...
    def test_oneGoodEach(self, mock_print, mock_run_dig, mock_rand_subdomain):
        ...
        mock_run_dig.side_effect = [None,  # Primer
                                    build_result(12), None,  # Latencies
                                    None, build_result(32)]  # Totals
        ...
        mock_print.assert_has_calls([call("{},{},12,32,20".format(recursive_ip, auth_ip))])
    ...
    def test_multipleGoodEach(self, mock_print, mock_run_dig, mock_rand_subdomain):
        ...
        mock_run_dig.side_effect = [None,  # Primer
                                    build_result(1), build_result(2), build_result(3),  # Latencies
                                    build_result(6), build_result(5), build_result(4)]  # Totals
        ...
        self.assertEqual(1, mock_print.call_count)
        mock_print.assert_has_calls([call("{},{},1,4,3".format(recursive_ip, auth_ip))])
